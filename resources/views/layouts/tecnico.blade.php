...
<div class="col-2">
    <div>
        ...
        <nav class="text-center bg-secondary d-flex flex-column justify-content-around" id="fixednav">
            <div>
                <a href="{{ route('tecnico.create') }}" class="btn btn-light btn-lg p-1 bg-secondary">
                    <!-- Clipboard check -->
            ...
            <div>
                <a href="{{ route('tecnico.show') }}" class="btn btn-light btn-lg p-1 bg-secondary">
                    <!-- Clipboard plus -->
            ...
            <div>
                <a href="{{ route('tecnico.historial') }}" class="btn btn-light btn-lg p-1 bg-secondary">
                    <!-- Clock history -->
            ...
            <div>
                <a href="{{ route('tecnico.manual') }}" class="btn btn-light btn-lg p-1 bg-secondary">
                    <!-- Journal text -->
            ...
            <div>
                <a href="{{ route('tecnico.piezas') }}" class="btn btn-light btn-lg p-1 bg-secondary">
                    <!-- Journal text -->
            ...
            <div>
                <a href="{{ route('tecnico.home') }}" class="btn btn-light btn-lg p-1 bg-secondary">
                    <!-- House -->
