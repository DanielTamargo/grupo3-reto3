...
<div class="col-2">
    <div>
        ...
        <nav class="text-center bg-success d-flex flex-column justify-content-around" id="fixednav">
            ...
            <div>
                <a href="{{ route('tecnico.show', ['cod' => $codUsr]) }}" class="btn btn-lg p-1 text-white border border-2 border-light">
                    <!-- Clipboard plus -->
            ...
            <div>
                <a href="{{ route('tecnico.historial', ['cod' => $codUsr]) }}" class="btn btn-lg p-1 text-white border border-2 border-light">
                    <!-- Clock history -->
            ...
            <div>
                <a href="{{ route('tecnico.manual', ['cod' => $codUsr]) }}" class="btn btn-lg p-1 text-white border border-2 border-light">
                    <!-- Journal text -->
            ...
            <div>
                <a href="{{ route('tecnico.piezas', ['cod' => $codUsr]) }}" class="btn btn-lg p-1 text-white border border-2 border-light">
                    <!-- Journal text -->
            ...
            <div>
                <a href="{{ route('tecnico.home', ['cod' => $codUsr]) }}" class="btn btn-lg p-1 text-white border border-2 border-light">
                    <!-- House -->
