...
<div class="col-2">
    <div>
        ...
        <nav class="text-center bg-azul2 d-flex flex-column justify-content-around" id="fixednav">
            <div>
                <a href="{{ route('tecnico.create') }}" class="btn btn-lg p-1 text-white border border-2 border-light">
                    <!-- Clipboard check -->
            ...
            <div>
                <a href="{{ route('tecnico.show') }}" class="btn btn-lg p-1 text-white border border-2 border-light">
                    <!-- Clipboard plus -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-clipboard-plus" viewBox="0 0 16 16">
            ...
            <div>
                <a href="{{ route('tecnico.historial') }}" class="btn btn-lg p-1 text-white border border-2 border-light">
                    <!-- Clock history -->
            ...
            <div>
                <a href="{{ route('tecnico.manual') }}" class="btn btn-lg p-1 text-white border border-2 border-light">
                    <!-- Journal text -->
            ...
            <div>
                <a href="{{ route('tecnico.piezas') }}" class="btn btn-lg p-1 text-white border border-2 border-light">
                    <!-- Tools -->
            ...
            <div>
                <a href="{{ route('tecnico.home') }}" class="btn btn-lg p-1 text-white border border-2 border-light">
                    <!-- House -->
