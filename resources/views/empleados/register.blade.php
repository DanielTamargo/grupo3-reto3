            ...
            <form id="registro-form" method="POST" action="{{ route('register.store') }}">
                ...
                <div class="row mb-4">
                    <div class="mb-3 col-12 col-md-6 col-xl-4">
                        ...
                        <input required type="text" name="nombre" id="registro-nombre" class="form-control" placeholder="" autocomplete="off">
                    </div>

                    <div class="mb-3 col-12 col-md-6 col-xl-4">
                        <label for="apellidos" class="">Apellidos</label>
                        <input required type="text" name="apellidos" id="registro-apellidos" class="form-control" placeholder="" autocomplete="off">
                    </div>

                    <div class="mb-3 col-12 col-md-4 col-xl-4">
                        <label for="dni" class="">DNI</label>
                        <input required type="text" name="dni" id="registro-dni" class="form-control" placeholder="" autocomplete="off">
                    </div>
                    
                    <div class="mb-3 col-12 col-md-4 col-xl-4">
                        <label for="telefono" class="">Teléfono</label>
                        <input required type="text" name="telefono" id="registro-telefono" class="form-control" placeholder="" autocomplete="off">
                    </div>

                    <div class="mb-3 col-12 col-md-8 col-xl-6">
                        <label for="email" class="">Email</label>
                        <div class="input-group">
                            <input required type="text" name="email" id="registro-email" class="form-control" placeholder="" autocomplete="off">
                    ...
                    <div class="mb-3 col-12 col-md-3 col-xl-2">
                        ...
                        <input required type="text" name="password" id="registro-password" class="form-control" placeholder="" autocomplete="off">
                    </div>
