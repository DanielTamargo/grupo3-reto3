...
@section('content')
    <div class="container px-4">
        <index-ascensores></index-ascensores>
        <div class="ascensores">
            ...
            <input type="hidden" id="assets-component-index-ascensores" value="{{ asset('js/components/index-ascensores.html') }}">
        ...
        <script src="{{ asset('js/views/ascensores.js')}}"></script>  
    </div>
@endsection