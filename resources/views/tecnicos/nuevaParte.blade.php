...
@section('content')
        ...
        <form action="" method="POST">
            ...
            <input type="text" name="idtarea" id="id" class="form-control rounded-pill bg-dark text-white">
            <label for="est" class="form-label">Estado:</label>
            <select name="estado" id="est" class="form-select rounded-pill bg-dark text-white">
                <!-- posibles estados -->
            ...
            <textarea name="anotacion" id="anot" cols="30" rows="10" class="form-control rounded-3 bg-dark text-white"></textarea>
